...
class C100Dataset:
    ...
    def __init__(self, filename):
        ...
        self.train_y = np.asarray(data['class'][:48005])  ### TODO: YOUR CODE HERE
        self.test_x = data_test_img  ### TODO: YOUR CODE HERE
        self.test_y = np.asarray(data['class'][48005:])  ### TODO: YOUR CODE HERE
...
if __name__ == '__main__':
    dataset_odn = C100Dataset('../dataset/cifar100_nl/data/p_cifar.csv')
